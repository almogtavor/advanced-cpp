...
// common::types::VoxelOccupancy code. Hidden maps loaded from .npy files are
...
[[nodiscard]] common::types::VoxelOccupancy decodeByte(std::int8_t raw) {
    switch (raw) {
    case static_cast<std::int8_t>(common::types::VoxelOccupancy::PotentiallyOccupied):
        return common::types::VoxelOccupancy::PotentiallyOccupied;
    case static_cast<std::int8_t>(common::types::VoxelOccupancy::OutOfBounds):
        return common::types::VoxelOccupancy::OutOfBounds;
    case static_cast<std::int8_t>(common::types::VoxelOccupancy::Unmapped):
        return common::types::VoxelOccupancy::Unmapped;
    case static_cast<std::int8_t>(common::types::VoxelOccupancy::Empty):
...
bool Map3DImpl::isInBounds(const Position3D& pos) const {
    const common::types::MappingBounds& b = config_.boundaries;
