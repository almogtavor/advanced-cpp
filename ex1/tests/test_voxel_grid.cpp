...
TEST(voxel_grid_continuous_to_cell) {
    ...
    CHECK_NEAR(center.x.numerical_value_in(cm), 25.0, 1e-9);
    CHECK_NEAR(center.y.numerical_value_in(cm),  5.0, 1e-9);
    CHECK_NEAR(center.z.numerical_value_in(cm), 95.0, 1e-9);
}
