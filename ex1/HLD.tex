...
The mp-units and gsl-lite header files are bundled under
\texttt{third\_party/} so that the submission is self-contained and
compiles without requiring these libraries to be pre-installed on the
build machine.
